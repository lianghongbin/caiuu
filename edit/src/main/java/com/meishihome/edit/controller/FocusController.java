...
import com.meishihome.edit.util.UploadUtils;
...
public class FocusController {
    ...
    public ModelAndView list() {
        ...
        return new ModelAndView("focus-list", "focuses", focuses);
    }

    @RequestMapping(value = "/view", method = RequestMethod.GET)
    public ModelAndView view() {
        return new ModelAndView("focus-view");
    }

    @RequestMapping(value = "/edit/{id}", method = RequestMethod.GET)
    public ModelAndView edit(@PathVariable int id) {
        Focus focus = focusService.find(id);
        return new ModelAndView("focus-edit", "focus", focus);
    }
